// Created by ALI ABAKCHOU 
//EMBEDDED SYSTEM ENGINEER

#include "Main.h"
///cv::VideoCapture cap(0);                        //if You are using an extern camera please remplace 0 with 1
///////////////////////////////////////////////////////////////////////////////////////////////////
int main(void) {
   ...
   imgOriginalScene = cv::imread("M5.jpg");         // open image
    //cap.read(imgOriginalScene);                // this ins for using the camera
...
void drawRedRectangleAroundPlate(cv::Mat &imgOriginalScene, PossiblePlate &licPlate) {
    ...
    for (int i = 0; i < 4; i++) {                                       // draw 4 red lines
        cv::line(imgOriginalScene, p2fRectPoints[i], p2fRectPoints[(i + 1) % 4], SCALAR_YELLOW, 2);
    }
}
...
void writeLicensePlateCharsOnImage(cv::Mat &imgOriginalScene, PossiblePlate &licPlate) {
    ...
    cv::putText(imgOriginalScene, licPlate.strChars, ptLowerLeftTextOrigin, intFontFace, dblFontScale, SCALAR_RED, intFontThickness);
}
